...
try:
    ...
    __author__ = 'Mr.Rajpoot'
    __copyright = 'All rights reserved . Copyright  Mr.Rajpoot'
...
def reg():
    ...
    r = requests.get('https://pastebin.com/raw/X081WEHs').text
    if to in r:
        ...
        os.system('xdg-open https://wa.me/+923481299584')
        reg()
...
def reg2():
    ...
    print ' \033[1;92mCopy and press enter , And Send Me On +923481299584'
